  ...
  <tr>
    ...
    <td class="text-center">
      <div class="btn-group d-flex align-items-center" role="group">
        <button @click="deleteOne" type="button" class="btn shadow-none">-</button>
        <span class="mx-2">{{ amount }}</span>
        <button @click="addMore" type="button" class="btn shadow-none">+</button>
      </div>
    </td>
    <td class="text-center py-3">${{ price }}</td>
    <td>
      <button @click="remove" class="btn shadow-none">
...
export default {
  ...
  methods: {
    ...
    deleteOne() {
      this.$root.deleteOne(this.index);
    }
  },
  props: {
    name: {
